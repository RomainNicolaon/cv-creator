...
- 🎨 4 thèmes : **Classique**, **Moderne** (2 colonnes), **Minimal**, **Terminal**.
...
```
components/
  EditorPanel.vue      # Formulaire d'édition
  CvPreview.vue        # Sélection du thème + mise à l'échelle
  themes/              # Un composant par thème
composables/useCv.ts   # État + persistance localStorage
constants/themes.ts    # Registre des thèmes
